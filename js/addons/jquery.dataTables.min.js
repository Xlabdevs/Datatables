...
sEmptyTable:"No data available in table",sInfo:"Menampilkan _START_ to _END_ of _TOTAL_ entri",sInfoEmpty:"Tampilkan 0 to 0 of 0 entri",sInfoFiltered:"(filtered from _MAX_ total entri)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Menampilkan _MENU_ entries",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Cari:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:h.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",sPaginationType:"simple_numbers",
...
sSortIcon:"DataTables_sort_icon",sScrollHead:"dataTables_scrollHead "+E,sScrollFoot:"dataTables_scrollFoot "+E,sHeaderTH:E,sFooterTH:E,sJUIHeader:Ub+" ui-corner-tl ui-corner-tr",sJUIFooter:Ub+" ui-corner-bl ui-corner-br"});var Lb=p.ext.pager;h.extend(Lb,{simple:function(){return["previous","next"]},full:function(){return["first","previous","next","last"]},simple_numbers:function(a,b){return["Sebelumnya",Ua(a,b),"Selanjutnya"]},full_numbers:function(a,b){return["first","Sebelumnya",Ua(a,b),"Selanjutnya","last"]},_numbers:Ua,
